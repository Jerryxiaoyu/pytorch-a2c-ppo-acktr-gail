...
class VG(VariantGenerator):
    ...
    @variant
    def env_name(self):
        return ['CellRobotEnvCPG6NewMultiTarget-v3', 'CellRobotEnvCPG6NewMultiTarget-v2']  # 'CellrobotEnv-v0' , 'Cellrobot2Env-v0', 'CellrobotSnakeEnv-v0'  , 'CellrobotSnake2Env-v0','CellrobotButterflyEnv-v0', 'CellrobotBigdog2Env-v0'
 ...
 ##----------------------------------------------------
    ...
    def command_mode(self):
        return [ "point" ]  # full, error, no FandE  point  conv_error
